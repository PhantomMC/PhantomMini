# -*- coding: utf-8 -*-
"""
Created on Fri Mar 19 19:43:55 2021

@author: ewized


Copied a version of ewized mcping; this can be used as  a
Virtual minecraft client (first 3 steps or something)
"""
...
fakeClient = StatusPing()
status = fakeClient.get_status()
print(status)
